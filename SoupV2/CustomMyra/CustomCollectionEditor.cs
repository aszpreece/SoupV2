...
{
    public class CustomCollectionEditor : SingleItemContainer<VerticalStackPanel>
	{
		...
		public CustomCollectionEditor(IList collection, Type type)
		{
			Width = 500;
			Height = 400;
			...
			_propertyGrid = new CustomPropertyGrid { GridColumn = 1 };
